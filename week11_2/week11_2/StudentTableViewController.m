...
- (void)viewDidLoad {
    ...
    Student *s = [NSEntityDescription insertNewObjectForEntityForName:@"Student" inManagedObjectContext:dm.managedObjectContext];
    ...
    NSError *error = nil;
    if ([dm.managedObjectContext save:&error] == NO) {
